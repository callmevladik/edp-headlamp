...
export const FormActions = () => {
  ...
  const {
    formData: { defectDojoSecret, isReadOnly },
  ...
  const handleDelete = React.useCallback(async () => {
    setDialog({
      ...
      forwardedProps: {
        ...
        kubeObjectData: defectDojoSecret as EDPKubeObjectInterface,
        objectName: defectDojoSecret?.metadata.name,
        description: `Confirm the deletion of the secret`,
      },
    });
  }, [defectDojoSecret, setDialog]);
